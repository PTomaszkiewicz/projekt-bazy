...
<body>
    ...
    <h1>Wyniki wyszukiwania dla: <?php echo $_GET["search"]; ?></h1>
    <div class='search-game'>
      ...
      <?php
        if ($_SESSION["userrole"]=="admin"){
            ...
            $sql="select id, name, mail, password, role, register_date from users where id like '%".$_GET["search"]."%' or name like '%".$_GET["search"]."%' or mail like '%".$_GET["search"]."%'";
            ...
            if (isset($todelete)){
                ...
                echo "Usunięto $deleteam użytkowników";
            }
