...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
      ...
      <br>";
      echo "<input type='submit' class='edit-review-butt' value='Zapisz'><input type='button' onclick='window.location.href=\"/22.04/gry/reviews/?gra=$gra&action=delete\"' class='edit-review-butt' value='Usuń'></form>";
    }
  } else {
...
if ($result2->num_rows > 0) {
  ...
  echo "<br>Nie ma jeszcze żadnych ocen";
}
